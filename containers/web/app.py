...
from views.regime_map import bp as regime_map_bp
from views.oos_v2 import bp as oos_v2_bp
...
app.register_blueprint(oos_v2_bp)
app.register_blueprint(regime_map_bp)
